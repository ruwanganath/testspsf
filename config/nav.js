...
let mapZoom=12;
let userLocation; 
let parkingLocation = new google.maps.LatLng(document.getElementById("info3-lat").value, document.getElementById("info3-lon").value);
...
function initMap() {
  ...
  calculateAndDisplayParkingRoute(directionsService, directionsDisplay, markerA, markerB);
...
// function calculateAndDisplayParkingRoute(directionsService, directionsDisplay, userLocation, parkingLocation) {
//   directionsService.route({
//     origin: userLocation,
